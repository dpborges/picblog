...
const mediaFileList = getImageFileList(mediaFolder);
...
//*******************************************************************
log("=================================================================")
log("Upload _next/static/media files")
log("=================================================================")

uploadImagesInMediaFolder(bucketName1);

// uploadImagesInMediaFolder(bucketName2); /* not required in invite domain */

//*******************************************************************
// Function to upload list of files to S3
//*******************************************************************
function uploadImagesInMediaFolder(bucketName) {
  log(`Upload media images into bucket ${bucketName}`)
  /* Upload images from out/media folder s3 media folder */
  let s3MediaPath = '_next/static/media';
  log(mediaFileList)
  uploadImages(mediaFileList, bucketName, s3MediaPath);
  log("Images loaded into s3 media folder for bucket ", bucketName);
}

...
// const icoFontFolder    = `${projectFolder}/out/images/icofont`;    
// const icoFontFileList   = shell.ls(`${icoFontFolder}/fonts/icofont.*`);
// const icoFontCssFile   = shell.ls(`${icoFontFolder}/*.css`);

//*******************************************************************
// Main 
//*******************************************************************
log("=================================================================")
log("Upload site images")
log("=================================================================")

uploadImagesToBucket(bucketName1);

uploadImagesToBucket(bucketName2);

//*******************************************************************
// Function to upload all images to S3 bucket
//*******************************************************************
function uploadImagesToBucket(bucketName)  {
  log(`...uploading to bucket: ${bucketName}`)
  /* Upload images from out/images folder s3 images folder */
  let s3ImagePath = 'images';
  uploadImages(imageFileList, bucketName, s3ImagePath);
  log("Images loaded into s3 images folder");

  /* Upload icofont files out/images/icofont. folder s3 images folder */
  // let icofontPath = 'images/icofont/fonts';
  // uploadImages(icoFontFileList, bucketName, icofontPath);
  // log("IcoFonts loaded into s3 images/icofont/fonts folder");

  // /* Upload icofont.min.css file  */
  // let icofontCssPath = 'images/icofont';
  // uploadFiles(icoFontCssFile, bucketName, icofontCssPath);
  // log("Loaded icofont.min.css into s3 images/icofont/ folder");
}

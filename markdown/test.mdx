...
import MobileAd from '../pages/blog/subcomponents/MobileAd';
import BlogImage from '../pages/blog/subcomponents/BlogImage';
import BlogInfo from '../pages/blog/subcomponents/BlogInfo';

<BlogImage src={props.image} alt={props.alt} />
<BlogInfo day={props.day} month={props.month} title={props.title} />
...
<MobileAd showAd={props.showAd} adStyle={props.adStyle} />
